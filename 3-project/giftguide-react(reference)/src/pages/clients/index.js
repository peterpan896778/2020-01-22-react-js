  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.clients !== this.props.clients) {
      ...
      for(let i=0; i<clients.length; i++) {
        if(clients[i].dob)
        {
          clients[i].dob = moment.utc(clients[i].dob).format("YYYY-MM-DD");
          clients[i].lastpurchasae = moment.utc(clients[i].lastpurchasae).format("YYYY-MM-DD");
          clients[i].nextFollowUpDate = moment.utc(clients[i].nextFollowUpDate).format("YYYY-MM-DD");
        }
      }
            ...
            <Col>
              ...
              <Row>
                  ...
                  <Col lg={10} className="mt-lg-3 text-right">
                    ...
                    &nbsp;&nbsp;
                    <CSVLink className="btn btn-success" data={this.state.csvData} headers={this.state.csvHeader} filename={"Client Data.csv"}>
                      Export
                    </CSVLink>
                  </Col>
                </Row>
