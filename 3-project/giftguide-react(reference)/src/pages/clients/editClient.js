...
import { getUser, getClients, getClient,updateClient } from "../../redux/actions";
...
const mapStateToProps = state => {
  const { clients, client, user, clientAdded,updateClientSuccess, loading, error } = state.User;
  return { clients, client, user, updateClientSuccess, clientAdded, loading, error };
};

export default connect(
  mapStateToProps,
  { getUser, getClients,updateClient, getClient }
)(EditClient);
